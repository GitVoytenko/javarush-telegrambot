...
import static com.github.gitvoytenko.jrtb.command.CommandName.ADD_GROUP_SUB;
import static com.github.gitvoytenko.jrtb.command.CommandUtils.getChatId;
import static com.github.gitvoytenko.jrtb.command.CommandUtils.getMessage;
...
public class AddGroupSubCommand implements Command{
    ...
    private void sendGroupIdList(Long chatId){
        ...
        String message = "Чтобы подписаться на группу - передай команду вместе с ID группы. \n" +
                ...
                "я подготовил список всех групп - выберай какую хочушь :) \n\n" +
                "%s";
